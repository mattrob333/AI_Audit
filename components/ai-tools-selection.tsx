...
export function AIToolsSelection({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>AI Tools You Use or Want to Explore</CardTitle>
        <CardDescription>
          Check any AI solutions you're currently using or curious about. Not sure?
          Select what you've heard of or skip to let us recommend later.
        </CardDescription>
      </CardHeader>
      <CardContent>
